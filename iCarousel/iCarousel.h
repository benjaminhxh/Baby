...
@property (nonatomic, assign) CGFloat perspective;//透视图
@property (nonatomic, assign) CGFloat decelerationRate;//减速
...
@property (nonatomic, assign) BOOL stopAtItemBoundary;//边界
@property (nonatomic, assign) BOOL scrollToItemBoundary;
@property (nonatomic, assign) BOOL ignorePerpendicularSwipes;//垂直猛击
@property (nonatomic, assign) BOOL centerItemWhenSelected;
@property (nonatomic, readonly, getter = isDragging) BOOL dragging;//拖拉
